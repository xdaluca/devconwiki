...
on L1 you can take ETH 💧:
- stake ETH 🥩 (turning it solid 🧊) and reducing the velocity of ETH  
- burn ETH 🔥 and consuming it with fees (turning it into gas 💨)  

### Temperature of money on Layer-2s

Similarly On L2 you can use ETH:
- as collateral 🧊 (bonding 🏦)  
- as currency 💧 (transacting🔁)  
...
- Security by staking 🥩 = contributing towards the **security** of the network.  
- Sustainability with base fees 🔥 = contributing towards its economic **sustainability** and security.  
- Bandwidth through collateral 🏦 = in the context of DeFi by using it as collateral.  
- Economic Activity when used as currency 🔁  

There are two different economies:  
Cold economy mostly collateral money (🥩 and 🏦).    
Hot economy mostly liquid money (🔥 and 🔁).  
...
Right now there is $0.37T of total value secured, a security ration of 20x. The lower the ratio the better. 
...
### ETH deposits
The economic security comes from ETH deposits. In the last two years, there has been a healthy continuous stream of deposits. An average of 20K ETH/day for 2-years. Today we have 14.2 ETH staked 🥩.
...
- no bridge risk  
- no governance risk  
- **volatility** is the one downside!
...
- 💧liquid economy (Hot)  
All the cashflows happen here, burn 🔥 and issuance 🖨. Burn is liquid ETH that is being burned to pay for blockspace. Issuance is "fresh" liquid ETH that is added to the circulating supply.
...
- partly as Staked ETH 🥩 (33M ETH)  
- partly as collateral 🏦 (33M ETH)  
- partly as currency 🔁 (33M ETH)  
